...
Begin VB.Form Remote 
   ...
   Begin PVMarqueeLib.PVMarquee Label7 
      ...
      Left            =   270
      TabIndex        =   28
      ToolTipText     =   "Отображение имени текущего мультимедийного файла."
      Top             =   315
      Width           =   2625
      _Version        =   393216
      _ExtentX        =   4630
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.DirListBox Dir1 
         ...
         Left            =   90
         TabIndex        =   4
         ToolTipText     =   "Выбор папки для поиска."
         Top             =   3870
         Width           =   5370
      End
      ...
      Begin VB.CommandButton cmdDn 
         ...
         Style           =   1  'Graphical
         TabIndex        =   18
         ToolTipText     =   "Переместить выбранный элемент вниз."
         Top             =   2970
         Width           =   285
      End
      Begin VB.CommandButton cmdUp 
         ...
         Style           =   1  'Graphical
         TabIndex        =   17
         ToolTipText     =   "Переместить выбранный элемент вверх."
         Top             =   2610
         Width           =   285
      End
      Begin VB.ComboBox Combo1 
         ...
         TabIndex        =   1
         Text            =   "Combo1"
         ToolTipText     =   "Имя исполнителя или другая информация."
         Top             =   270
         Width           =   2085
      End
      Begin VB.ListBox List1 
         ...
         OLEDropMode     =   1  'Manual
         TabIndex        =   5
         ToolTipText     =   "Файлы занесённые в список для воспроизведения."
         Top             =   765
         Width           =   2175
      End
      ...
      Begin VB.ListBox List2 
         ...
         Sorted          =   -1  'True
         TabIndex        =   26
         ToolTipText     =   "Найденные мультимедийные файлы."
         Top             =   765
         Width           =   2085
      End
      ...
      Begin MediaPlayer2.PBarY PBarY1 
         ...
         Left            =   0
         TabIndex        =   30
         ToolTipText     =   "Индикатор прогресса и ручная прокрутка."
         Top             =   0
         Width           =   5595
         _ExtentX        =   9869
         _ExtentY        =   185
   ...
   Begin VB.Label Label8 
      ...
      Left            =   360
      TabIndex        =   20
      ToolTipText     =   "Какой файл проигрывается и сколько всего в списке."
      Top             =   1305
      Width           =   1035
   End
   Begin VB.Line Line6 
   ...
   Begin VB.Label Label10 
      ...
      Left            =   180
      TabIndex        =   19
      ToolTipText     =   "Тип мультимедийного файла."
      Top             =   855
      Width           =   1365
   End
   Begin VB.Line Line8 
...
Dim ModeTime As Integer     ' Модель отображения часов
Dim V As iVol               ' Переменная для Volume
Dim Vol As tVol
...
'------------ Начинается обработка коммандной строки-------------
...
ModeTime = 1
Case 1              ' Остаток времени проигрывания в Сек
ModeTime = 2
Case 2              ' Остаток времени проигрывания в фрагментах
ModeTime = 0
End Select
cmdStop.SetFocus
End Sub
